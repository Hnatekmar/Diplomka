...
\label{sec:fitnessDesign}
I přesto, že návrh fitness funkce spíše iterativní proces, který lze provést až po implementaci simulačního prostředí, lze si několik pravidel odvodit jíž v návrhu.

Je zřejmé, že bude třeba agenta nějakým způsobem penalizovat za nevhodné chování, jako je například kolize s překážkou. Možností penalizace agenta je hodně. Může to být buď předčasné přerušení simulace, které znemožní agentovi získat větší hodnotu fitness nebo to také může nabírat podoby odečtení určitého množství bodů z fitness skore agenta.

Míra a podoba penalizace závisí na odzkoušeném chování agenta, který se může v rámci maximalizace fitness funkce chovat nepředvídatelně a bude jej tedy možné určit, až po implementace práce. Pro ilustraci nepředvídatelných akcí si můžeme například představit agenta auto, které se díky špatně nastavené fitness funkci rozhodne jezdit po chodníku jenom proto, že penalizace srážky chodce je menší, než penalizace za kolizi s vozidlem. 

Dalším faktorem, který musí být do fitness funkce zahrnut je motivace agenta. Na ní totiž ve velké míře závisí jeho výsledky. Může to být například požadavek na maximalizaci rychlosti agenta nebo můžeme například brát ohled na ujetou vzdálenost.
